...
(function ($) {
    ...
    $.fn.fileinputLocales['zh'] = {
        ...
        msgImageWidthSmall: '瀹藉害鐨勫浘鍍忔枃浠剁殑"{name}"鐨勫繀椤绘槸鑷冲皯{size}鍍忕礌.',
        msgImageHeightSmall: '鍥惧儚鏂囦欢鐨�"{name}"鐨勯珮搴﹀繀椤昏嚦灏戜负{size}鍍忕礌.',
        msgImageWidthLarge: '瀹藉害鐨勫浘鍍忔枃浠�"{name}"涓嶈兘瓒呰繃{size}鍍忕礌.',
        msgImageHeightLarge: '鍥惧儚鏂囦欢"{name}"鐨勯珮搴︿笉鑳借秴杩噞size}鍍忕礌.',
        msgImageResizeError: '鏃犳硶鑾峰彇鐨勫浘鍍忓昂瀵歌皟鏁淬€�',
        msgImageResizeException: '閿欒鑰岃皟鏁村浘鍍忓ぇ灏忋€�<pre>{errors}</pre>',
        dropZoneTitle: '鎷栨嫿鏂囦欢鍒拌繖閲� &hellip;',
        fileActionSettings: {
            removeTitle: '鍒犻櫎鏂囦欢',
            uploadTitle: '涓婁紶鏂囦欢',
