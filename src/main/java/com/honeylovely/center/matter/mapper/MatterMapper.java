package com.honeylovely.center.matter.mapper;
...
import com.honeylovely.center.matter.mapper.sqlprovider.MatterSqlProvider;
...
public interface MatterMapper extends Mapper<Matter> {
	...
	@SelectProvider(method = "statisticsDataByUserId", type = MatterSqlProvider.class)
	List<Map> statisticsData(@Param("queryUserId") Long queryUserId);
}
